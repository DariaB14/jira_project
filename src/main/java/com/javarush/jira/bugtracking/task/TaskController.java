...
public class TaskController {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void setTags(@PathVariable long id, @RequestBody Set<@Size(min = 2, max = 32) String> tags) {
        log.info("set tags {} to task with id={}", tags, id);
    ...
    public void deleteTag(@PathVariable long id, @PathVariable String tag) {
        log.info("delete tag '{}' from task with id={}", tag, id);
